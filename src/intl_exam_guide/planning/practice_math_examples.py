...
def _kinematics_graph_topic(text: str) -> bool:
    return has_terms(
        text, ["kinematic", "kinematics", "motion", "displacement", "velocity", "speed"]
    ) and has_terms(text, ["graph", "graphs", "gradient", "area under"])
...
def mathematics_specialist_example(
    ...
    if has_terms(text, ["inequality", "inequalities"]):
        return (
            ...
            [
                "Find the boundary values by solving x^2 - 5x + 6 = 0.",
                "Use a sign table or number line.",
                "Choose the intervals where the expression is positive.",
            ],
            [
                "x^2 - 5x + 6 = (x - 2)(x - 3), so the boundary values are x = 2 and x = 3.",
                "The quadratic is positive outside the two roots.",
                "Therefore the solution is x < 2 or x > 3.",
                "Answer: x < 2 or x > 3.",
            ],
            [
                "The inequality sign is answered, not just the equation.",
                "The boundary values split the number line into intervals.",
                "The middle interval 2 < x < 3 is rejected.",
            ],
        )
    if has_terms(text, ["binomial expansion"]):
        return (
            ...
            [
                "Use binomial coefficients from row 5.",
                "Write the powers of x in order.",
                "Stop at the requested term.",
            ],
            [
                "(1 + x)^5 = 1 + 5x + 10x^2 + 10x^3 + 5x^4 + x^5.",
                "Up to and including x^3 gives 1 + 5x + 10x^2 + 10x^3.",
                "Answer: 1 + 5x + 10x^2 + 10x^3.",
            ],
            [
                "The coefficients 1, 5, 10, 10 are used in order.",
                "The powers of x increase by 1 each time.",
                "Terms beyond x^3 are not included.",
            ],
        )
    if has_terms(text, ["trigonometric equations", "simple trigonometric equations"]):
        return (
            ...
            [
                ...
                "Use the quadrants where sine is positive.",
                "Keep only solutions inside the interval.",
            ],
            [
                "The reference angle is 30 degrees.",
                "Sine is positive in quadrants I and II.",
                "So x = 30 degrees or x = 150 degrees.",
                "Answer: 30 degrees, 150 degrees.",
            ],
            [
                "Both interval solutions are included.",
                "The interval endpoint rule is followed.",
                "The answer solves the equation rather than only converting units.",
            ],
        )
    if has_terms(text, ["sine and cosine rules", "sine rule", "cosine rule"]):
        return (
            ...
            [
                "Choose the cosine rule because two sides and the included angle are known.",
                "Substitute into c^2 = a^2 + b^2 - 2ab cos C.",
                "Square-root and round appropriately.",
            ],
            [
                "c^2 = 8^2 + 11^2 - 2(8)(11)cos37 degrees.",
                "c^2 = 185 - 176cos37 degrees.",
                "c is approximately 6.67.",
                "Answer: c = 6.67 cm to 3 significant figures.",
            ],
            [
                "The included angle is used.",
                "The cosine rule is used instead of a right-angle formula.",
                "The final answer has a length unit.",
            ],
        )
    if has_terms(text, ["area of a triangle", "1/2 ab sin", "1/2ab sin"]):
        return (
            ...
            [
                "Use the non-right-angled triangle area formula.",
                "Substitute the two sides and included angle.",
                "Round the area with square units.",
            ],
            [
                "Area = 1/2 ab sin C.",
                "Area = 1/2 x 7 x 10 x sin40 degrees.",
                "Area is approximately 22.5.",
                "Answer: 22.5 cm^2.",
            ],
            [
                "The angle is between the two given sides.",
                "The sine formula is used for area, not the sine rule.",
                "The unit is squared.",
            ],
        )
    if has_terms(
        text,
        ["trigonometrical identities", "trigonometric identities", "tan theta", "sin^2", "cos^2"],
    ):
        return (
            "Use sin^2 x + cos^2 x = 1 to simplify 1 - cos^2 x.",
            [
                "Choose the identity that contains sin^2 x and cos^2 x.",
                "Rearrange the identity.",
                "Replace the expression with the equivalent trig term.",
            ],
            [
                "sin^2 x + cos^2 x = 1.",
            ...
            [
                "The identity is rearranged, not memorised as a loose phrase.",
                "Squares stay attached to the trig functions.",
                "The simplified expression is equivalent for all allowed x.",
            ],
        )
    if has_terms(text, ["variable acceleration"]) or (
        ...
        if has_terms(text, ["application of calculus"]):
            return (
                ...
                [
                    "The calculus operation is chosen from the required quantity.",
                    "Velocity is differentiated once.",
                    "The final value uses the stated time.",
                ],
            )
        if has_terms(text, ["restricted to the calculus", "as unit p1"]):
            return (
                ...
                [
                    ...
                    "Use v(0)=2 to find the constant.",
                ],
                ["v(t)=integral 6t dt = 3t^2 + C.", "v(0)=C=2.", "Answer: v(t)=3t^2+2."],
                [
                    "Only basic integration is needed.",
                    "The initial condition fixes C.",
                    "The result is a velocity function.",
                ],
            )
        return (
            ...
            [
                ...
                "a(t) = dv/dt = 6t - 12.",
                "v(2) = 3(2)^2 - 12(2) + 9 = -3.",
                "Answer: v(t)=3t^2-12t+9, a(t)=6t-12, and v(2)=-3 m/s.",
            ],
            [
                "This is calculus, not constant-acceleration SUVAT.",
    ...
    if has_terms(
    ...
    ) and not has_terms(text, ["random variable", "random variables", "discrete random"]):
        if has_terms(text, ["relative frequencies"]):
            return (
                ...
                [
                    ...
                    "Write the estimate as a decimal or fraction.",
                    "State that it is an estimate.",
                ],
                [
                    "Estimated probability = 31/50.",
                    "31/50 = 0.62.",
                    "Answer: estimated probability of heads is 0.62.",
                ],
                [
                    "Relative frequency uses observed results.",
                    "The answer is an estimate, not an exact value.",
        ...
        if has_terms(text, ["addition law"]):
            return (
                ...
                [
                    "The overlap is not double-counted.",
                    "The addition law is named.",
        ...
        if has_terms(text, ["multiplication law", "conditional probability"]):
            return (
                ...
                [
                    "The conditional probability is used in the correct direction.",
                    "The result is a joint probability.",
                    "The answer is between 0 and 1.",
                ],
            )
        ...
        return (
            ...
            [
                ...
                "There are 2 favourable outcomes out of 6 equally likely outcomes.",
                "P(number > 4) = 2/6 = 1/3.",
                "Answer: 1/3.",
            ],
            [
                "Equal likelihood means simple counting works.",
                "The probability is reduced to simplest form.",
                "The sample space has 6 outcomes.",
            ],
        )
    if has_terms(
        text, ["using algebraic methods", "equal roots", "distinct real roots", "no real roots"]
    ):
        return (
            "Two curves intersect when x^2 - 4x + 5 = 0. Use the discriminant to decide whether the curves meet.",
            [
                "Write the intersection equation.",
                "Calculate the discriminant.",
                "Interpret the sign of the discriminant in context.",
            ],
            [
                "For x^2 - 4x + 5 = 0, a=1, b=-4, c=5.",
                "b^2 - 4ac = 16 - 20 = -4.",
                "The discriminant is negative.",
                "Answer: there are no real intersections.",
            ],
            [
                "The discriminant links algebra to graph intersections.",
                "No real roots means no real intersection points.",
                "The conclusion is stated in context.",
            ],
        )
    if has_terms(text, ["geometrical interpretation", "algebraic solution"]):
        return (
            ...
            [
                "Solve or identify the root structure.",
                "Connect a repeated root to a single contact point.",
                "State the graphical interpretation.",
            ],
            [
                "x^2 - 4x + 4 = (x - 2)^2.",
                "There is one repeated root, x = 2.",
                "A repeated root means the graphs touch at one point.",
                "Answer: the graphs are tangent or just touch at the intersection.",
            ],
            [
                "The root count is interpreted geometrically.",
                "A repeated root is not two crossings.",
                "The answer describes the graph relationship.",
            ],
        )
    if has_terms(text, ["simultaneous equations"]):
        return (
            ...
            [
                ...
                "Substitute each x-value into either equation.",
            ],
            [
                "x + 1 = x^2 - 5, so x^2 - x - 6 = 0.",
                "(x - 3)(x + 2) = 0, so x = 3 or x = -2.",
                "Then y = 4 or y = -1.",
                "Answer: (3, 4) and (-2, -1).",
            ],
            [
                "Both coordinates are found.",
                "The equations are solved together.",
                "The answers can be checked in both equations.",
            ],
        )
    if has_terms(text, ["translation of circles", "translated circle"]):
        return (
            ...
            [
                "Move the centre by the translation vector.",
                "Keep the radius the same.",
                "Write the completed-square form.",
            ],
            [
                "The original centre is (0,0) and radius is 3.",
                "After translation the centre is (4,-2).",
                "New equation: (x-4)^2 + (y+2)^2 = 9.",
                "Answer: (x-4)^2 + (y+2)^2 = 9.",
            ],
            [
                "A translation changes the centre, not the radius.",
                "The y-coordinate sign changes correctly.",
                "The final equation matches the new centre.",
            ],
        )
    if has_terms(text, ["surd", "surds", "rationalisation"]):
        return (
            ...
            [
                "Write each surd using square factors.",
                "Collect like surds.",
                "Multiply numerator and denominator by sqrt(2).",
            ],
            [
                "sqrt(72) = sqrt(36 x 2) = 6sqrt(2).",
                "sqrt(18) = sqrt(9 x 2) = 3sqrt(2), so the sum is 9sqrt(2).",
                "5/sqrt(2) = 5sqrt(2)/2.",
                "Answer: 9sqrt(2) and 5sqrt(2)/2.",
            ],
            [
                "Square factors are taken outside the root.",
                "Only like surds are combined.",
                "The denominator is rational after rationalising.",
            ],
        )
        ...
        if has_terms(text, ["graph"]):
            return (
                ...
                [
                    ...
                    "Use the shape of an exponential graph.",
                    "State the asymptote behaviour.",
                ],
                [
                    "When x = 0, y = 2^0 = 1.",
                    "As x becomes very negative, 2^x gets closer to 0 but stays positive.",
                    "Answer: y-intercept (0, 1); the graph approaches y = 0.",
                ],
                [
                    "The intercept is found from x = 0.",
                    "The graph stays above the x-axis.",
                    "The horizontal asymptote is described in words.",
                ],
            )
        return (
            ...
            [
                ...
                "Equate the powers.",
                "Connect the answer to log notation.",
            ],
            [
                "81 = 3^4.",
                "So 3^x = 3^4 gives x = 4.",
                "In log form, log_3 81 = 4.",
                "Answer: x = 4.",
            ],
            [
                "The base is 3.",
                "The logarithm statement matches the exponential statement.",
    ...
    if has_terms(text, ["indices", "index", "rational exponent", "rational exponents"]):
        return (
            ...
            [
                "Use the index law for multiplying powers with the same base.",
                "Add the exponents.",
                "Translate the one-half power into surd notation.",
            ],
            [
                "a^(3/2) x a^(1/2) = a^(3/2 + 1/2).",
                "3/2 + 1/2 = 4/2 = 2.",
                "So the product is a^2.",
                "a^(1/2) = sqrt(a).",
            ],
            [
                "The base stays as a.",
                "Only exponents are added for multiplication.",
                "The rational exponent is converted to the matching root.",
            ],
        )
    ...
    if has_terms(text, ["quadratic equation", "quadratic equations"]) and not has_terms(
        ...
        return (
            ...
            [
                ...
                "The factor signs produce -7x.",
                "The answer is solving an equation, not an inequality.",
            ],
        )
        ...
        if has_terms(text, ["factorisation", "quadratic formula"]):
            return (
                ...
                [
                    ...
                    "Connect the rearranged form to the quadratic formula method.",
                ],
                [
                    "x^2 + 6x + 2 = (x + 3)^2 - 7.",
                    "So (x + 3)^2 = 7.",
                    "x = -3 +/- sqrt(7).",
                    "Answer: x = -3 +/- sqrt(7); the quadratic formula is the same algebra rearranged.",
                ],
                [
                    "The square is completed before solving.",
                    "Both plus and minus roots are included.",
                    "The method matches a quadratic-equation topic.",
                ],
            )
        return (
            ...
            [
                "Half of 6 is 3.",
                "x^2 + 6x - 1 = (x+3)^2 - 9 - 1.",
                "So x^2 + 6x - 1 = (x+3)^2 - 10.",
                "Answer: (x+3)^2 - 10.",
            ],
            [
                "The bracket uses half the x coefficient.",
                "The extra 9 is subtracted back.",
                "Expanding the answer checks it.",
            ],
        )
    if has_terms(text, ["factorisation", "factorization"]) and has_terms(
        text, ["quadratic", "quadratics"]
    ):
        return (
            "Factorise 2x^2 + x - 6.",
            [
                "Find two terms whose product matches 2x^2 and -6.",
            ...
            [
                "Expanding gives 2x^2 + x - 6.",
                "The signs in the brackets are correct.",
                "Both factors are included.",
            ],
        )
    if has_terms(
        text, ["sine", "cosine", "tangent", "trigonometry", "trigonometric"]
    ) and has_terms(text, ["graphs", "symmetries", "periodicity", "period"]):
        return (
            "For y = sin x on 0 <= x <= 360 degrees, state the period and the x-values where y = 0.",
            [
                "Use the standard sine graph.",
                "Read one full cycle.",
                "List the zeros in the interval.",
            ],
            [
                "The sine graph repeats every 360 degrees, so the period is 360 degrees.",
                "On 0 <= x <= 360 degrees, sin x = 0 at x = 0, 180 and 360 degrees.",
                "Answer: period 360 degrees; zeros at 0, 180 and 360 degrees.",
            ],
            [
                "The graph property is trigonometric, not quadratic.",
                "Both endpoints are included.",
                "The answer is tied to the stated interval.",
            ],
        )
    if "|r|<1" in text.replace(" ", "") or has_terms(text, ["convergent"]):
        if has_terms(text, ["sum to infinity"]):
            return (
                ...
                [
                    "Here |r| = 0.4 < 1, so the sum to infinity exists.",
                    "S_infinity = 5/(1 - 0.4).",
                    "S_infinity = 5/0.6 = 25/3.",
                    "Answer: 25/3.",
                ],
                [
                    "The convergence condition is checked.",
                    "The first term is used as a.",
                    "The answer is for an infinite sum.",
                ],
            )
        return (
            "A geometric series has common ratio r = -0.6. Use |r|<1 to decide whether it is convergent.",
            [
                "Find the absolute value of the common ratio.",
                "Compare it with 1.",
                "State the convergence conclusion.",
            ],
            [
                "Here |r| = |-0.6| = 0.6.",
                "Since 0.6 < 1, the condition |r|<1 is satisfied.",
                "Answer: the geometric series is convergent.",
            ],
            [
                "The absolute value of r is used.",
                "The comparison is with 1.",
                "The conclusion names the geometric-series condition.",
            ],
        )
    if _kinematics_graph_topic(text):
        if has_terms(text, ["sketching", "interpreting"]):
            return (
                ...
                [
                    "Use gradient on a displacement-time graph to represent velocity.",
                    "Constant positive velocity gives a straight rising line.",
                    "Rest gives a horizontal line.",
                ],
                [
                    "From 0 to 4 seconds, displacement increases at a constant rate, so the graph is a straight rising line.",
                    "From 4 to 6 seconds, the particle rests, so displacement is constant.",
                    "Answer: rising straight line followed by a horizontal segment.",
                ],
                [
                    "The axes are displacement and time.",
                    "Rest is horizontal on a displacement-time graph.",
                    "The sketch matches the motion story.",
                ],
            )
        return (
            ...
            [
                "Use the gradient of a velocity-time graph for acceleration.",
                "Use the area under the graph for displacement.",
                "State units.",
            ],
            [
                "Acceleration = (10 - 2)/(4 - 0) = 2 m/s^2.",
                "Displacement is the area of the trapezium under the graph.",
                "Area = 1/2 x (2 + 10) x 4 = 24.",
                "Answer: acceleration 2 m/s^2; displacement 24 m.",
            ],
            [
                "The graph is velocity-time, not displacement-time.",
        ...
        if has_terms(text, ["vice versa", "interpreting the solutions"]):
            return (
                ...
                [
                    ...
                    "Translate intersections into equation solutions.",
                    "State the solution set.",
                ],
                [
                    "Solutions of f(x)=g(x) occur where the graphs have equal y-values.",
                    "The intersections have x-coordinates -1 and 3.",
                    "Answer: x = -1 or x = 3.",
                ],
                [
                    "Only the x-values are needed for the equation solution.",
                    "The graph reading is translated back into algebra.",
                    "Both intersections are included.",
                ],
            )
        return (
            ...
            [
                "Intersection means the y-values are equal.",
                "Both coordinates are given.",
                "The algebra is interpreted as graph intersections.",
            ],
        )
    if _quadratic_graph_topic(text):
        return (
            ...
            [
                ...
                "Read the horizontal shift carefully.",
                "The line of symmetry passes through the vertex.",
            ],
            [
                "The minimum point is at x = 3.",
                "The y-value there is 2.",
                "So the vertex is (3, 2).",
                "Answer: vertex (3, 2), line of symmetry x = 3.",
            ],
            [
                "The sign inside the bracket reverses for the x-coordinate.",
                "The line of symmetry is vertical.",
                "The answer describes the graph, not just the equation.",
            ],
        )
        ...
        if has_terms(text, ["remainder is", "factor and vice versa"]):
            return (
                ...
                [
                    ...
                    "State the result as the remainder.",
                ],
                [
                    "f(2)=2(2)^3-3(2)+5.",
                    "f(2)=16-6+5=15.",
                ...
                [
                    "The divisor x-2 gives x=2.",
                    "No full division is needed.",
                    "The value is the remainder, not the quotient.",
                ],
            )
        return (
            ...
            [
                "The divisor x-2 gives x=2.",
                "The value of f(2) is the remainder.",
    ...
    if has_terms(text, ["factor theorem", "remainder theorem"]):
        if has_terms(text, ["use of the remainder theorem and the factor theorem"]):
            return (
                ...
                [
                    ...
                    "Interpret each value as a remainder.",
                    "A zero remainder identifies a factor.",
                ],
                [
                    "f(1)=1-1-4+4=0, so x-1 is a factor.",
                    "f(2)=8-4-8+4=0, so x-2 is also a factor.",
                    "Both tested divisors give zero remainders.",
                    "Answer: x-1 and x-2 are factors.",
                ],
                [
                    "Each divisor gives its own test value.",
                    "Zero means factor.",
                    "The theorem is used rather than guessed from a graph.",
                ],
            )
        if has_terms(text, ["application"]):
            return (
                ...
                [
                    "Use x+2 = 0 to find the test value.",
                    "Evaluate f(-2).",
                ...
                [
                    "The test value is -2.",
                    "A zero value means factor.",
                    "The conclusion names x+2.",
                ],
            )
        return (
            ...
            [
                "The test value has the correct sign.",
                "A zero value means factor, not just root by guesswork.",
                "The conclusion names the factor.",
            ],
        )
    if has_terms(text, ["circle", "circles"]):
        if has_terms(text, ["tangent", "normal"]):
            return (
                ...
                [
                    ...
                    "Use the perpendicular-gradient rule for the tangent.",
                    "State the tangent gradient.",
                ],
                [
                    "The radius from (0,0) to (3,4) has gradient 4/3.",
        ...
        return (
            ...
            [
                ...
                "Read the centre signs carefully.",
                "Square-root the right-hand side.",
            ],
            ["The centre is (3, -2).", "r^2 = 25.", "r = 5.", "Answer: centre (3, -2), radius 5."],
            [
                "The y-coordinate sign is not copied as +2.",
                "The radius is positive.",
                "The equation is in completed-square circle form.",
            ],
        )
    if has_terms(text, ["sine, cosine and tangent functions", "sine cosine and tangent functions"]):
        return (
            ...
            [
                "Use sine as opposite over hypotenuse.",
                "Substitute the given side lengths.",
                "Simplify if possible.",
            ],
            ["sin A = opposite / hypotenuse.", "sin A = 5/13.", "Answer: 5/13."],
            [
                "The correct trig ratio is selected.",
                "The hypotenuse is the denominator.",
                "No radian conversion is needed.",
            ],
        )
    if has_terms(text, ["trigonometry", "radian", "radians", "sine", "cosine"]):
        return (
            ...
            [
                ...
                "sin(pi/3)=sin 60 degrees.",
                "Answer: sqrt(3)/2.",
            ],
            [
                "Radian conversion uses pi radians = 180 degrees.",
                "The exact value is not rounded.",
    ...
    if has_terms(text, ["sequence", "sequences", "series", "arithmetic", "geometric"]):
        if has_terms(text, ["x_(n+1)", "recurrence", "simple relation"]):
            return (
                ...
                [
                    "Use the recurrence relation one step at a time.",
                    "Substitute x_1 to find x_2.",
                    "Substitute x_2 to find x_3.",
                ],
                ["x_2 = 3(2) - 1 = 5.", "x_3 = 3(5) - 1 = 14.", "Answer: x_2 = 5 and x_3 = 14."],
                [
                    "Each term uses the previous term.",
                    "The starting value is used first.",
                    "Do not treat n as the term value.",
                ],
            )
        if has_terms(text, ["finite geometric series"]):
            return (
                ...
                [
                    "This is finite, not sum to infinity.",
                    "The common ratio is used as r.",
        ...
        if has_terms(text, ["arithmetic series", "natural numbers"]):
            return (
                ...
                [
                    "S_n = n(n+1)/2 for the first n natural numbers.",
                    "S_20 = 20(21)/2.",
                    "Answer: 210.",
                ],
                [
                    "The formula is for 1 + 2 + ... + n.",
                    "n is 20.",
                    "The result is a sum, not the 20th term.",
                ],
            )
        return (
            ...
            [
                ...
                "S_12 = 12/2 x (7 + 51).",
                "S_12 = 6 x 58 = 348.",
                "Answer: 12th term 51; sum 348.",
            ],
            [
                "n-1 is used in the nth-term formula.",
                "The first and last terms are used in the sum.",
                "The answer separates term and sum.",
            ],
        )
    if has_terms(
        text, ["coordinate", "coordinates", "straight line", "gradient", "perpendicular"]
    ) and not has_terms(
        text,
        [
            "acceleration",
        ...
        if has_terms(text, ["parallel"]):
            return (
                ...
                [
                    ...
                    "Read the gradient from y = mx + c.",
                    "State the matching gradient.",
                ],
                [
                    "For y = 2x + 5, the gradient is 2.",
                    "A parallel line has the same gradient.",
                    "Answer: gradient 2.",
                ],
                [
                    "The y-intercept is not needed.",
                    "Parallel means same gradient.",
                    "The answer is a gradient, not an equation.",
                ],
            )
        if has_terms(text, ["perpendicular"]):
            return (
                ...
                [
                    "Use m1 x m2 = -1 for perpendicular lines.",
                    "Substitute m1 = 4.",
                    "Solve for m2.",
                ],
        ...
        if has_terms(text, ["intersection of a straight line and a curve"]):
            return (
                ...
                [
                    "Both intersection points are given.",
                    "The line and curve equations are both used.",
                    "The answer includes coordinates.",
                ],
            )
        return (
            ...
            [
                ...
                "The point is substituted into the line equation.",
                "The final equation is in terms of x and y.",
            ],
        )
    if has_terms(text, ["indefinite integration as the reverse of differentiation"]):
        return (
            ...
            [
                ...
                "Compare it with the integrand.",
                "Explain the role of C.",
            ],
            [
                "d/dx(2x^3 - 5x + C) = 6x^2 - 5.",
                "This matches the integrand.",
                "C differentiates to 0, so any constant is possible.",
                "Answer: 2x^3 - 5x + C is an indefinite integral.",
            ],
            [
                "Integration reverses differentiation.",
                "The constant C is explained.",
                "The check is done by differentiating.",
            ],
        )
    if has_terms(
        text, ["derivative", "differentiation", "tangent", "gradient", "stationary", "second order"]
    ):
        if has_terms(text, ["notation", "notations", "dy/dx", "f'"]):
            return (
                "If f(x)=x^3, write f'(x) and dy/dx for y=x^3.",
                [
                    "Use derivative notation for f.",
                    "Use dy/dx notation for y.",
                    "Differentiate x^3.",
                ],
                ["f'(x)=3x^2.", "For y=x^3, dy/dx=3x^2.", "Answer: f'(x)=3x^2 and dy/dx=3x^2."],
                [
                    "Both notations mean the derivative in this context.",
                    "The power rule is applied once.",
                    "The notation matches the function name.",
                ],
            )
        if has_terms(text, ["second order"]):
            return (
                ...
                [
                    "Differentiate once to find dy/dx.",
                    "Differentiate again.",
                    "State the second derivative.",
                ],
                ["dy/dx = 3x^2 - 6x.", "d2y/dx2 = 6x - 6.", "Answer: d2y/dx2 = 6x - 6."],
                [
                    "The function is differentiated twice.",
                    "The notation means second derivative.",
                    "The final expression is not set equal to zero unless asked.",
                ],
            )
        if has_terms(text, ["general appreciation", "interpreting it"]):
            return (
                ...
                [
                    "Connect derivative to local rate of change.",
                    "Use the x-value as the point of interpretation.",
                    "State what the sign and size mean.",
                ],
                [
                    "The derivative at x = 2 is the gradient of the tangent there.",
                    "A value of 5 means y is increasing at 5 units of y per unit of x at that point.",
                    "Answer: the local rate of change is 5.",
                ],
                [
                    "This is interpretation, not another differentiation calculation.",
                    "The derivative is local to the point.",
                    "The positive value means increasing.",
                ],
            )
        if has_terms(text, ["x^n", "rational number"]):
            return (
                ...
                [
                    "Use the power rule for each rational power.",
                    "Reduce each exponent by 1.",
                    "Keep negative powers in exact form.",
                ],
                ["dy/dx = (1/2)x^(-1/2) - 2x^(-3).", "Answer: dy/dx = 1/(2sqrt(x)) - 2/x^3."],
                [
                    "The fractional power is differentiated by the same rule.",
                    "The negative exponent is handled carefully.",
        ...
        if has_terms(text, ["polynomials"]):
            return (
                ...
                [
                    ...
                    "Answer: dy/dx = 12x^2 - 10x.",
                ],
                [
                    "Each power is reduced by 1.",
                    "Coefficients are multiplied by the old power.",
                    "Constants disappear.",
                ],
            )
        if has_terms(text, ["maxima", "minima", "stationary", "increasing", "decreasing"]):
            return (
                ...
                [
                    ...
                    "Set dy/dx = 0.",
                    "Substitute the x-value back into y.",
                ],
                [
                    "dy/dx = 2x - 6.",
                    "2x - 6 = 0 gives x = 3.",
                    "y = 3^2 - 6(3) + 8 = -1.",
                    "Answer: stationary point (3, -1).",
                ],
                [
                    "A stationary point has zero gradient.",
                    "The y-coordinate is found by substitution.",
        ...
        if has_terms(text, ["normal"]):
            return (
                ...
                [
                    ...
                    "The tangent and normal gradients multiply to -1.",
                    "Solve for the normal gradient.",
                ],
        ...
        return (
            ...
            [
                "dy/dx = 6x - 4.",
                "When x = 2, dy/dx = 6(2) - 4.",
                "The gradient is 8.",
                "Answer: dy/dx = 6x - 4; tangent gradient = 8.",
            ],
            [
                "The constant differentiates to 0.",
                "The x-value is substituted after differentiating.",
    ...
    if has_terms(text, ["trapezium"]):
        return (
            ...
            [
                "List the ordinates at x = 0, 1, 2, 3 and 4.",
                "Substitute them into h/2(first + last + 2 x middle sum).",
                "State that the result is an estimate.",
            ],
            [
                "The ordinates are 0, 1, 4, 9 and 16.",
                "With h = 1, estimate = 1/2[0 + 16 + 2(1 + 4 + 9)].",
                "Estimate = 1/2[16 + 28] = 22.",
                "Answer: the estimated area is 22 square units.",
            ],
            [
                "The internal ordinates are doubled.",
                "The width h is included.",
                "The answer is described as an estimate, not an exact integral.",
            ],
        )
    if has_terms(text, ["integration", "integral", "area under"]):
        if has_terms(text, ["interpretation of the definite integral as the area under a curve"]):
            return (
                ...
                [
                    "Identify the interval on the x-axis.",
                    "Connect the integral to area under the curve.",
                    "State the condition about positivity.",
                ],
                [
                    "The limits x = 1 and x = 4 mark the horizontal interval.",
                    "For a positive function, the definite integral gives the area between the curve and the x-axis.",
                    "Answer: it represents that area over 1 <= x <= 4.",
                ],
                [
                    "This is interpretation, not just calculation.",
                    "The area is tied to the limits.",
                    "The positivity condition avoids signed-area confusion.",
                ],
            )
        if has_terms(text, ["definite integral", "evaluation of definite"]):
            return (
                ...
                [
                    ...
                    "At x=3, x^3=27; at x=1, x^3=1.",
                    "27 - 1 = 26.",
                    "Answer: 26.",
                ],
                [
                    "Upper minus lower is used.",
                    "No constant C is needed for a definite integral.",
                    "The antiderivative differentiates back to 3x^2.",
                ],
            )
        if has_terms(text, ["x^n", "rational number"]):
            return (
                ...
                [
                    "Integral of x^(1/2) is x^(3/2)/(3/2) = (2/3)x^(3/2).",
                    "Integral of 2x^3 is (1/2)x^4.",
                    "Answer: (2/3)x^(3/2) + (1/2)x^4 + C.",
                ],
                [
                    "The fractional power rule is used.",
                    "The constant C is included.",
                    "The excluded n=-1 case is avoided.",
                ],
            )
        if has_terms(text, ["area", "curve", "x-axis"]):
            return (
                ...
                [
                    "Area = integral from 1 to 4 of 2x dx.",
                    "An antiderivative of 2x is x^2.",
                    "Area = 4^2 - 1^2 = 16 - 1.",
                    "Answer: 15 square units.",
                ],
                [
                    "The limits are used in the correct order.",
                    "The antiderivative is checked by differentiating.",
                    "Area is positive.",
                ],
            )
        return (
            ...
            [
                "The power rule is reversed.",
                "The constant C is included.",
                "Differentiating the answer checks the integrand.",
            ],
        )
    ...
    if has_terms(text, ["binomial", "bernoulli"]):
        if has_terms(text, ["deductions of np", "corresponding values"]):
            return (
                ...
                [
                    "Recall the Bernoulli mean and variance.",
                    "Scale from one trial to n independent trials.",
                    "State the binomial results.",
                ],
                [
                    "For one Bernoulli trial, mean is p and variance is p(1-p).",
                    "For n independent trials, the binomial mean is np.",
                    "The binomial variance is np(1-p).",
                    "Answer: E(X)=np, Var(X)=np(1-p).",
                ],
                [
                    "The result is derived from repeated Bernoulli trials.",
                    "The variance includes 1-p.",
                    "No numerical substitution is needed.",
                ],
            )
        if has_terms(text, ["conditions for application"]):
            return (
                ...
                [
                    ...
                    "State the constant probability condition.",
                ],
                [
                    "There are two outcomes: defective or not defective.",
                    "One outcome can be called success.",
                    "If the success probability is fixed for the trial, it is Bernoulli.",
                    "Answer: two outcomes with fixed success probability.",
                ],
                [
                    "The model condition is stated, not calculated.",
                    "Success is defined clearly.",
                    "Only one trial is being described.",
                ],
            )
        if has_terms(text, ["calculation of probabilities", "formula and tables"]):
            return (
                ...
                [
                    ...
                    "Substitute n=8, p=0.25 and x=3.",
                    "Leave as an exact expression if no calculator is required.",
                ],
                [
                    "P(X=3)=C(8,3)(0.25)^3(0.75)^5.",
                    "This is the formula expression for exactly 3 successes.",
                    "Answer: C(8,3)(0.25)^3(0.75)^5.",
                ],
                [
                    "The success power is 3.",
                    "The failure power is 5.",
                    "The combination term counts arrangements.",
                ],
            )
        if not has_terms(text, ["mean", "variance", "standard deviation"]):
            if has_terms(text, ["binomial distribution"]):
                return (
                    ...
                    [
                        "Identify n.",
                        "Identify p.",
                        "Connect the notation to repeated Bernoulli trials.",
                    ],
                    [
                        "n is the number of independent trials.",
                        "p is the probability of success on each trial.",
                        "Answer: X ~ B(n,p) is defined by n and p.",
                    ],
                    [
                        "The distribution is described, not immediately calculated.",
                        "n and p have different meanings.",
            ...
            return (
                ...
                [
                    "Use the binomial probability formula.",
                    "Substitute n=5, p=0.4 and x=2.",
                    "Keep the combination term.",
                ],
                [
                    "P(X=2)=C(5,2)(0.4)^2(0.6)^3.",
                    "C(5,2)=10.",
                    "P(X=2)=10 x 0.16 x 0.216.",
                    "Answer: P(X=2)=0.3456.",
                ],
                [
                    "The power of 0.4 matches the number of successes.",
                    "The power of 0.6 matches failures.",
                    "The combination counts arrangements.",
                ],
            )
        if has_terms(text, ["mean and variance of a bernoulli"]):
            return (
                ...
                [
                    "This is one Bernoulli trial, not B(n,p).",
                    "The variance uses 1-p.",
                    "No n value is needed.",
                ],
            )
        return (
            ...
            [
                "E(X)=10 x 0.3 = 3.",
                "Var(X)=10 x 0.3 x 0.7.",
                "Var(X)=2.1.",
                "Answer: E(X)=3 and Var(X)=2.1.",
            ],
            [
                "The value of 1-p is 0.7.",
                "Expectation and variance use different formulae.",
                "X is identified as binomial.",
            ],
        )
    if has_terms(text, ["random variable", "variance", "standard deviation"]):
        if has_terms(text, ["sum or difference"]):
            return (
                ...
                [
                    "Subtract expectations for X-Y.",
                    "Add variances because X and Y are independent.",
                    "State both results.",
                ],
                [
                    "E(X-Y)=8-3=5.",
                    "Var(X-Y)=Var(X)+Var(Y)=5+2=7.",
                    "Answer: E(X-Y)=5 and Var(X-Y)=7.",
                ],
                [
                    "Variance adds for a difference when variables are independent.",
                    "Expectation follows the sign.",
                    "Do not subtract variances.",
                ],
            )
        if has_terms(text, ["sum", "independent"]):
            return (
                ...
                [
                    "Add expectations.",
                    "Use independence to add variances.",
                ...
                [
                    ...
                    "Var(X+Y)=1.5+2=3.5.",
                    "Answer: E(X+Y)=7 and Var(X+Y)=3.5.",
                ],
                [
                    "Independence is needed for adding variances.",
        ...
        if has_terms(text, ["associated probability distributions"]):
            return (
                ...
                [
                    ...
                    "Pair each value with its probability.",
                    "Check that the probabilities sum to 1.",
                ],
                [
                    "The distribution is x: 1, 2, 3 with probabilities 0.2, 0.3, 0.5.",
                    "The probabilities add to 1.",
                    "Answer: the table defines the distribution.",
                ],
                [
                    "A distribution pairs values with probabilities.",
        ...
        if has_terms(text, ["number of possible outcomes", "finite"]):
            return (
                ...
                [
                    "The possible outcomes are finite: 0, 1 and 2.",
        ...
        if has_terms(text, ["simple function"]):
            return (
                ...
                [
                    "Use the linearity rule for expectation.",
                    "Use the scaling rule for variance.",
                    "Substitute the values.",
                ],
                [
                    "E(2X+1)=2E(X)+1=9.",
                    "Var(2X+1)=2^2 Var(X)=12.",
                    "Answer: E(2X+1)=9 and Var(2X+1)=12.",
                ],
                [
                    "Adding 1 changes the expectation.",
                    "Adding 1 does not change the variance.",
                    "The multiplier is squared for variance.",
                ],
            )
        if has_terms(text, ["mean, variance and standard deviation for discrete random variables"]):
            return (
                ...
                [
                    "Take the positive square root for standard deviation.",
                    "Keep the variance as the spread measure.",
                    "State both meanings clearly.",
                ],
                [
                    "Standard deviation = sqrt(0.64)=0.8.",
                    "Variance measures the average squared spread about the mean.",
                    "Answer: standard deviation 0.8; variance measures spread.",
                ],
                [
                    "Standard deviation is the square root of variance.",
                    "Variance and standard deviation are not the same number.",
                    "The interpretation is included.",
                ],
            )
        if has_terms(text, ["standard deviation"]):
            return (
                ...
                [
                    "Use standard deviation as the square root of variance.",
                    "Take the positive square root.",
                    "State the unit if one is given.",
                ],
                ["Standard deviation = sqrt(2.25).", "sqrt(2.25)=1.5.", "Answer: 1.5."],
                [
                    "Standard deviation is not the variance itself.",
                    "The square root is positive.",
                    "The answer measures spread.",
                ],
            )
        ...
        if has_terms(text, ["central tendency"]):
            return (
                ...
                [
                    ...
                    "Add the products.",
                    "Interpret the mean as a long-run average.",
                ],
                ["E(X)=1(0.25)+5(0.75).", "E(X)=0.25+3.75=4.", "Answer: E(X)=4."],
                [
                    "The probabilities weight the values.",
                    "The mean need not be equally spaced.",
                    "The answer is an expected value.",
                ],
            )
        return (
            ...
            [
                "The probabilities add to 0.2 + 0.5 + 0.3 = 1.",
                "E(X) = 0(0.2) + 1(0.5) + 2(0.3).",
                "E(X) = 0 + 0.5 + 0.6 = 1.1.",
                "Answer: E(X) = 1.1.",
            ],
            [
                "Each x-value is weighted by its probability.",
                "Probabilities sum to 1.",
                "Expectation is not necessarily a possible value of X.",
            ],
        )
    if "vertical motion under gravity" in text:
        return (
            ...
            [
                ...
                "At greatest height, the velocity is 0.",
                "Use v = u + at with acceleration -g.",
            ],
            ["Use v = u + at.", "0 = 19.6 - 9.8t.", "9.8t = 19.6.", "Answer: t = 2 s."],
            [
                "The acceleration is downwards.",
                "The sign of g matches the chosen positive direction.",
                "The velocity at the top is zero.",
            ],
        )
    if has_terms(
        text, ["displacement", "speed", "velocity", "acceleration", "motion"]
    ) and not has_terms(
        text,
        ...
        if has_terms(text, ["difference between displacement", "difference between velocity"]):
            return (
                ...
                [
                    "Distance adds the path lengths.",
                    "Displacement uses final position from the start.",
                    "Keep direction for displacement.",
                ],
                [
                    "Distance = 100 + 40 = 140 m.",
                    "Displacement = 100 - 40 = 60 m east.",
                    "Answer: distance 140 m; displacement 60 m east.",
                ],
                [
                    "Distance is scalar.",
        ...
        if has_terms(text, ["constant acceleration equations"]):
            return (
                ...
                [
                    "Choose the constant-acceleration equation.",
                    "Substitute u=4, a=3, t=5.",
                    "Calculate v.",
                ],
                ...
                [
                    ...
                    "The final velocity has unit m/s.",
                ],
            )
        if has_terms(text, ["average speed"]):
            return (
                ...
                [
                    ...
                    "Substitute the distance and time.",
                    "Give the unit.",
                ],
                [
                    "Average speed = 120 / 8.",
                    "120 / 8 = 15.",
                    "Answer: 15 m/s.",
                    "This is an average over the whole journey.",
                ],
        ...
        return (
            ...
            [
                ...
                "Acceleration is multiplied by time.",
                "Velocity has unit m/s.",
            ],
        )
    if has_terms(text, ["conservation of momentum"]):
        return (
            ...
            [
                "Write total momentum before the collision.",
                "Write total momentum after the collision.",
                "Equate the two totals and solve.",
            ],
            [
                "Momentum before = 2 x 5 + 3 x 0 = 10.",
                "Momentum after = 2 x 1 + 3v = 2 + 3v.",
                "Conservation gives 10 = 2 + 3v.",
                "Answer: v = 8/3 m/s.",
            ],
            [
                "Both particles are included in the system.",
                "Directions are kept consistent.",
                "The answer is a speed in m/s.",
            ],
        )
    if has_terms(text, ["direct impact", "fixed surface"]):
        return (
            ...
            [
                "Write the initial momentum with the chosen sign.",
                "Write the final momentum after rebound.",
                "Calculate final momentum minus initial momentum.",
            ],
            [
                "Initial momentum = 0.5 x 6 = 3 kg m/s.",
                "Final velocity is -4 m/s, so final momentum = 0.5 x (-4) = -2 kg m/s.",
                "Change in momentum = -2 - 3 = -5 kg m/s.",
                "Answer: change in momentum = -5 kg m/s.",
            ],
            [
                "The rebound velocity has the opposite sign.",
                "Change means final minus initial.",
                "The fixed wall is not assigned a velocity.",
            ],
        )
    if has_terms(text, ["concept of momentum", "momentum = mv"]):
        return (
            ...
            [
                ...
                "p = 3 x 4.",
                "p = 12.",
                "Answer: momentum = 12 kg m/s in the direction of motion.",
            ],
    ...
    if has_terms(text, ["impulse"]):
        return (
            ...
            [
                ...
                "Subtract initial momentum from final momentum.",
                "State the sign and unit.",
            ],
            [
                "Impulse = final momentum - initial momentum.",
                "Impulse = 5 - 12.",
                "Impulse = -7.",
                "Answer: impulse = -7 N s.",
            ],
            [
                "The sign shows the impulse acts opposite to the original direction.",
                "N s is equivalent to kg m/s.",
                "Use change in momentum, not total momentum.",
            ],
        )
    ...
    if has_terms(text, ["normal reaction", "normal reactions"]):
        return (
            ...
            [
                "Resolve forces perpendicular to the surface.",
                "Use equilibrium in the vertical direction.",
                "Substitute W = mg.",
            ],
            [
                "The weight is W = 6 x 9.8 = 58.8 N.",
                "On a horizontal surface with no other vertical forces, R = W.",
                "Answer: normal reaction R = 58.8 N.",
            ],
            [
                "The reaction is perpendicular to the surface.",
                "Vertical equilibrium is used.",
    ...
    if has_terms(text, ["tension", "tensions", "thrust", "thrusts"]):
        return (
            ...
            [
                "Treat the tension as the resultant horizontal force.",
                "Use F = ma.",
            ...
            [
                ...
                "The surface is smooth, so no friction force is included.",
                "The unit is m/s^2.",
            ],
        )
    if has_terms(text, ["three laws", "newton’ s three laws", "newton's three laws"]):
        return (
            ...
            [
                "Recognise constant velocity means zero acceleration.",
                "Use F = ma.",
                "State the Newton's-law interpretation.",
            ],
            [
                "If acceleration is 0, F = ma = 0.",
                "So the resultant force is 0 N.",
                "Answer: resultant force 0 N; this is Newton's first law/equilibrium idea.",
            ],
            [
                "Constant velocity is not the same as speeding up.",
                "Resultant force, not total force, is zero.",
                "The law is linked to motion.",
            ],
        )
    if has_terms(text, ["resistive", "friction"]):
        return (
            ...
            [
                "Find the resultant force in the direction of motion.",
                "Use F = ma.",
                "Solve for acceleration.",
            ],
            [
                "Resultant force = 20 - 5 = 15 N.",
                "15 = 3a.",
                "a = 5.",
                "Answer: acceleration = 5 m/s^2.",
            ],
            [
                "The resistive force acts opposite motion.",
                "Only the resultant force is used in F = ma.",
                "The unit is m/s^2.",
            ],
        )
    if has_terms(
        text,
        ["force", "forces", "newton", "motion", "velocity", "acceleration", "momentum", "impulse"],
    ):
        return (
    ...
    return (
        ...
        [
            "Identify the exact formula, graph feature, notation, or model named in the question.",
            "Write the first line of working using that named idea.",
            "Check that the method belongs to this topic, not a neighbouring one.",
        ],
        [
            f"For {focus}, start by naming the required method from the syllabus point.",
            "Then substitute the given quantities or translate the stated condition into algebra.",
            "Before finalising, check signs, units, interval restrictions, or notation.",
            "Answer: the first method and check must match the named syllabus point.",
        ],
        [
            "The worked method is tied to the topic wording.",
            "No unrelated quadratic or graph template is imported.",
            "The final check targets the common boundary of the unit.",
        ],
    )
...
def mathematics_specialist_example_zh(
    ...
    if has_terms(text, ["surd", "surds", "rationalisation"]):
        return (
            ...
            [
                ...
                "sqrt(18)=sqrt(9×2)=3sqrt(2)，所以和为 9sqrt(2)。",
                "5/sqrt(2)=5sqrt(2)/2。",
                "答案：9sqrt(2)，5sqrt(2)/2。",
            ],
    ...
    if has_terms(
        text, ["quadratic function", "quadratic functions", "graphs", "vertex", "line of symmetry"]
    ):
        return (
    ...
    if has_terms(text, ["random variable", "variance", "standard deviation"]):
        if has_terms(text, ["sum", "independent"]):
            return (
                ...
                [
                    "E(X+Y)=E(X)+E(Y)=4+3=7。",
                    "因为 X 和 Y 独立，Var(X+Y)=Var(X)+Var(Y)。",
                    "Var(X+Y)=1.5+2=3.5。",
                    "答案：E(X+Y)=7，Var(X+Y)=3.5。",
                ],
    ...
    if has_terms(text, ["direct impact", "fixed surface"]):
        return (
            ...
            [
                "初动量 = 0.5×6 = 3 kg m/s。",
                "反弹后速度为 -4 m/s，所以末动量 = 0.5×(-4) = -2 kg m/s。",
                "动量变化 = -2 - 3 = -5 kg m/s。",
                "答案：动量变化 = -5 kg m/s。",
            ],
